...
public interface IUserActivityLogRepository : IGenericRepository<UserActivityLog>
{
    ...
    Task<IEnumerable<UserActivityLog>> GetByActionAsync(ActionEnum action, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<UserActivityLog>> GetByEntityAsync(string entity, Guid entityId, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<UserActivityLog>> GetRecentActivityAsync(int count = 100, CancellationToken cancellationToken = default);
    ...
    Task<int> GetActivityCountByActionAsync(ActionEnum action, DateTime? startDate = null, DateTime? endDate = null, CancellationToken cancellationToken = default);
    ...
    Task<int> GetActivityCountByUserAsync(Guid userId, DateTime? startDate = null, DateTime? endDate = null, CancellationToken cancellationToken = default);
    ...
    Task<Dictionary<ActionEnum, int>> GetActivityStatisticsByActionAsync(DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default);
    ...
    Task<Dictionary<DateTime, int>> GetDailyActivityStatisticsAsync(int days, CancellationToken cancellationToken = default);
    ...
    Task<Dictionary<Guid, int>> GetMostActiveUsersAsync(int count = 10, DateTime? startDate = null, DateTime? endDate = null, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<UserActivityLog>> GetFailedLoginAttemptsByIpAsync(string ipAddress, int timeWindow = 60, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<UserActivityLog>> GetSuspiciousActivitiesAsync(int timeWindow = 24, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<UserActivityLog>> GetMultipleIpActivitiesAsync(Guid userId, int timeWindow = 24, CancellationToken cancellationToken = default);
