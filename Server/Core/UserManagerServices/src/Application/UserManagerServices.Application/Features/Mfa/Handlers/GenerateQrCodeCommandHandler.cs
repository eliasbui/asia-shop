...
/// <summary>
/// Handler for regenerating QR code command
/// </summary>
public class GenerateQrCodeCommandHandler(
    IMfaService mfaService,
    ITotpService totpService,
    ILogger<GenerateQrCodeCommandHandler> logger)
    : IRequestHandler<GenerateQrCodeCommand, BaseResponse<MfaSetupResponse>>
{
    ...
    public async Task<BaseResponse<MfaSetupResponse>> Handle(GenerateQrCodeCommand request,
