...
public class UpdateNotificationSettingsCommandHandler(
    ...
    : IRequestHandler<UpdateNotificationSettingsCommand, BaseResponse<NotificationSettingsResponse>>
{
    /// <summary>
    ...
    public async Task<BaseResponse<NotificationSettingsResponse>> Handle(UpdateNotificationSettingsCommand request,
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            if (user == null)
            {
                ...
                return BaseResponse<NotificationSettingsResponse>.Failure("User not found",
            ...
            var updatedSettings =
                await unitOfWork.Users.GetUserNotificationSettingsAsync(request.UserId, cancellationToken);
