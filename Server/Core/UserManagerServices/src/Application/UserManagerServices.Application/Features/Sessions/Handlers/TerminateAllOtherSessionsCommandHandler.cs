...
/// </summary>
public class TerminateAllOtherSessionsCommandHandler : IRequestHandler<TerminateAllOtherSessionsCommand, BaseResponse<int>>
{
    ...
    public async Task<BaseResponse<int>> Handle(TerminateAllOtherSessionsCommand request, CancellationToken cancellationToken)
    {
        try
        {
